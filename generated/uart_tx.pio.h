...
static const uint16_t uart_tx_program_instructions[] = {
            //     .wrap_target
    0x9fa0, //  0: pull   block           side 1 [7] @@@E:\GitHub\esp-usb-bridge-pico\pio_uart_logger\uart_tx.pio:13
    0xf727, //  1: set    x, 7            side 0 [7] @@@E:\GitHub\esp-usb-bridge-pico\pio_uart_logger\uart_tx.pio:14
    0x6001, //  2: out    pins, 1                    @@@E:\GitHub\esp-usb-bridge-pico\pio_uart_logger\uart_tx.pio:16
    0x0642, //  3: jmp    x--, 2                 [6] @@@E:\GitHub\esp-usb-bridge-pico\pio_uart_logger\uart_tx.pio:17
            //     .wrap
};
